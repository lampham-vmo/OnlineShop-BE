...
export class LoginResultDTO {
    ...
    constructor(accessToken: string, refreshToken: string, permission: Permission[]){
        this.accessToken = accessToken;
        this.refreshToken = refreshToken;
        this.permission = permission;
    }
}
export class AccessTokenDTO extends PickType(LoginResultDTO, ['accessToken'] as const){
